...
class CrowIndividual(object):
    ...
    def evaluate_fitness(self):
        ...
        self.loss,self.accuracy,self.mae,self.mse,self.msle,self.training_history,self.epochs_history,self.model_json,self.gpu_device= model.validate()#cross_validate()
